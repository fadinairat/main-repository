...
<body>
    <div>
        @include("Control.partials._topbar")
        

        <div id="wrapper">
            @include ("Control.partials._sidebar")
            <!--BEGIN CHAT FORM-->
                ...
                <div id="chat-box" style="top: 400px">
                    ...
                    <div class="chat-content">
                        <ul class="chat-box-body">
                            <li>
                                <p>
                                    <img src="{{ URL::asset('') }}public/assets/KAdmin/images/avatar/128.jpg" class="avt" /><span class="user">John Doe</span><span
                            ...
                            <li class="odd">
                                <p>
                                    <img src="{{ URL::asset('') }}public/assets/KAdmin/images/avatar/48.jpg" class="avt" /><span class="user">Swlabs</span><span
                                        class="time">09:33</span></p>
                                <p>
...
@include("Control.partials._javascript")
@yield("footer_js")
