                ...
                <div class="portlet box">
                    ...
                    <div class="portlet-body">
                        <div class="chat-scroller">
                            <ul class="chats">
                                <li class="in">
                                    <img src="{{ URL::asset('') }}public/assets/KAdmin/images/avatar/48.jpg" class="avatar img-responsive" />
                                    <div class="message">
                        ...
                        <div class="profile">
                            <div style="margin-bottom: 15px" class="row">
                                ...
                                <div class="col-xs-12 col-sm-4 text-center">
                                    <figure><img src="{{ URL::asset('') }}public/assets/KAdmin/images/avatar/128.jpg" alt="" style="display: inline-block" class="img-responsive img-circle"/>
