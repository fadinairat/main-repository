...
@section("content")   
	<div class="container" style="min-height:500px;border-top:solid 1px #ccc;padding-top:15px;" >
		...
		<div class="row"><div class="col-xs-12 text-center" ><p class="title" ><?php echo $category["c_".\Session("prefix")."name"]; ?></p></div></div>

		<?php if($category["c_".\Session("prefix")."description"]!="") { ?><div class="row"><div class="col-xs-12 text" ><?php echo filterBody($category["c_".\Session("prefix")."description"]) ?></div></div><?php } ?>
